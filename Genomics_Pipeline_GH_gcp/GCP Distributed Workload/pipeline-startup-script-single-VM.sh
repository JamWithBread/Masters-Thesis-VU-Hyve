...
### Copy Python scripts to VM working directory ###

mkdir -p /home/jeren/pipeline-scripts
gsutil cp gs://hvd-pgp-genomics-files/pipeline-scripts/keys/service-account-key.json /home/jeren/pipeline-scripts/keys/service-account-key.json #CHANGE THIS TO FULL DIR
gsutil -m cp -r gs://hvd-pgp-genomics-files/pipeline-scripts/* /home/jeren/pipeline-scripts/ #CHANGE THIS TO FULL DIR
...
ZONE=us-east4-c
INSTANCE_GROUP=instance-group-single-vm-non-eu
...
### Assign subset of files to be processed in VM ###

gsutil cp gs://hvd-pgp-genomics-files/VM_startup/assign-files-single-vm.py /home/jeren
python3 /home/jeren/assign-files-single-vm.py 
...
# Delete the VM instance from group
